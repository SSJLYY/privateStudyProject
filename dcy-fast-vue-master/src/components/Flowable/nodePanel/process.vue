...
import mixinExecutionListener from '@/libs/flowable/common/mixinExecutionListener'
import signalDialog from './property/signal'
import { commonParse } from '@/libs/flowable/common/parseElement'
export default {
  components: {
    signalDialog
  },
  ...
  methods: {
    computedSignalLength() {
      ...
      this.signalLength = (len === null || len === undefined ? 0 : len)
    },
    finishSignal() {
