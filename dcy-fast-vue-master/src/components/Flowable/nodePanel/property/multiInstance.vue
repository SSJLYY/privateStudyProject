...
import { formatJsonKeyValue } from '@/libs/flowable/common/parseElement'
export default {
  mixins: [mixinPanel],
  data() {
    return {
  ...
  mounted() {
    let obj = this.element.businessObject.loopCharacteristics
    const cache = JSON.parse(JSON.stringify( obj != null ? obj : {}))
