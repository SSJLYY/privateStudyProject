...
<script>
// 汉化
import customTranslate from '@/libs/flowable/common/customTranslate'
import Modeler from 'bpmn-js/lib/Modeler'
import panel from './PropertyPanel'
import BpmData from '@/libs/flowable/BpmData'
import getInitStr from '@/libs/flowable/config/init'
// 引入flowable的节点文件
import flowableModdle from '@/libs/flowable/config/flowable.json'
export default {
  ...
  methods: {
    ...
    getProcess() {
      ...
      let description;
      if (element.documentation !== undefined && element.documentation !== null){
